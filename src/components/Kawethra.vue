...
/**Colors**/
/**Background colors**/
.bg-red{background-color:var(--kw-red)}
.bg-yellow{background-color:var(--kw-yellow)}
.bg-orange{background-color:var(--kw-orange)}
.bg-orange-2{background-color:var(--kw-emre)}
.bg-blue{background-color:var(--kw-blue)}
.bg-blue-2{background-color:var(--kw-exe)}
.bg-blue-3{background-color:var(--kw-rope)}
.bg-purple{background-color:var(--kw-purple)}
.bg-purple-2{background-color:var(--kw-sogloys)}
.bg-green{background-color:var(--kw-green)}
.bg-lime{background-color:var(--kw-lime)}
.bg-teal{background-color:var(--kw-teal)}
.bg-cyan{background-color:var(--kw-cyan)}
.bg-dark{background-color:var(--kw-dark)}
.bg-light{background-color:var(--kw-light)}
.bg-black{background-color:var(--kw-black)}
.bg-sky{background-color:var(--kw-sky)}
.bg-black-900{background-color:var(--kw-black-900)}
.bg-black-800{background-color:var(--kw-black-800)}
.bg-black-700{background-color:var(--kw-black-700)}
.bg-black-600{background-color:var(--kw-black-600)}
.bg-black-500{background-color:var(--kw-black-500)}
.bg-black-400{background-color:var(--kw-black-400)}
.bg-black-300{background-color:var(--kw-black-300)}
.bg-black-200{background-color:var(--kw-black-200)}
.bg-black-100{background-color:var(--kw-black-100)}
.bg-sky-900{background-color:var(--kw-sky-900)}
.bg-sky-800{background-color:var(--kw-sky-800)}
.bg-sky-700{background-color:var(--kw-sky-700)}
.bg-sky-600{background-color:var(--kw-sky-600)}
.bg-sky-500{background-color:var(--kw-sky-500)}
.bg-sky-400{background-color:var(--kw-sky-400)}
.bg-sky-300{background-color:var(--kw-sky-300)}
.bg-sky-200{background-color:var(--kw-sky-200)}
.bg-sky-100{background-color:var(--kw-sky-100)}
/**Text Colors**/
.c-red{color:var(--kw-red)}
.c-yellow{color:var(--kw-yellow)}
.c-orange{color:var(--kw-orange)}
.c-orange-2{background-color:var(--kw-emre)}
.c-blue{color:var(--kw-blue)}
.c-blue-2{color:var(--kw-exe)}
.c-blue-3{color:var(--kw-rope)}
.c-purple{color:var(--kw-purple)}
.c-purple-2{color:var(--kw-sogloys)}
.c-green{color:var(--kw-green)}
.c-lime{color:var(--kw-lime)}
.c-teal{color:var(--kw-teal)}
.c-cyan{color:var(--kw-cyan)}
.c-dark{color:var(--kw-dark)}
.c-sky{color:var(--kw-sky)}
.c-black{color:var(--kw-black)}
.c-black-900{color:var(--kw-black-900)}
.c-black-800{color:var(--kw-black-800)}
.c-black-700{color:var(--kw-black-700)}
.c-black-600{color:var(--kw-black-600)}
.c-black-500{color:var(--kw-black-500)}
.c-black-400{color:var(--kw-black-400)}
.c-black-300{color:var(--kw-black-300)}
.c-black-200{color:var(--kw-black-200)}
.c-black-100{color:var(--kw-black-100)}
.c-sky-900{color:var(--kw-sky-900)}
.c-sky-800{color:var(--kw-sky-800)}
.c-sky-700{color:var(--kw-sky-700)}
.c-sky-600{color:var(--kw-sky-600)}
.c-sky-500{color:var(--kw-sky-500)}
.c-sky-400{color:var(--kw-sky-400)}
.c-sky-300{color:var(--kw-sky-300)}
.c-sky-200{color:var(--kw-sky-200)}
.c-sky-100{color:var(--kw-sky-100)}
.c-light{color:var(--kw-light)}
/**Border colors**/
.border-red{
border-style:solid;
border-width:1px;
...
border-style:solid;
border-width:1px;
border-color:var(--kw-exe)
}
.border-blue-3{
border-style:solid;
border-width:1px;
border-color:var(--kw-rope)
}
.border-purple{
border-style:solid;
border-width:1px;
...
border-style:solid;
border-width:1px;
border-color:var(--kw-dark)
}
.border-sky{
border-style:solid;
border-width:1px;
border-color:var(--kw-sky)
}
.border-black{
border-style:solid;
border-width:1px;
...
border-style:solid;
border-width:1px;
border-color:var(--kw-black-900)
}
.border-black-800{
border-style:solid;
border-width:1px;
border-color:var(--kw-black-800)
}
.border-black-700{
border-style:solid;
border-width:1px;
border-color:var(--kw-black-700)
}
.border-black-600{
border-style:solid;
border-width:1px;
border-color:var(--kw-black-600)
}
.border-black-500{
border-style:solid;
border-width:1px;
border-color:var(--kw-black-500)
}
.border-black-400{
border-style:solid;
border-width:1px;
border-color:var(--kw-black-400)
}
.border-black-300{
border-style:solid;
border-width:1px;
border-color:var(--kw-black-300)
}
.border-black-200{
border-style:solid;
border-width:1px;
border-color:var(--kw-black-200)
}
.border-black-100{
border-style:solid;
border-width:1px;
border-color:var(--kw-black-100)
}
.border-sky-900{
border-style:solid;
border-width:1px;
border-color:var(--kw-sky-900)
}
.border-sky-800{
border-style:solid;
border-width:1px;
border-color:var(--kw-sky-800)
}
.border-sky-700{
border-style:solid;
border-width:1px;
border-color:var(--kw-sky-700)
}
.border-sky-600{
border-style:solid;
border-width:1px;
border-color:var(--kw-sky-600)
}
.border-sky-500{
border-style:solid;
border-width:1px;
border-color:var(--kw-sky-500)
}
.border-sky-400{
border-style:solid;
border-width:1px;
border-color:var(--kw-sky-400)
}
.border-sky-300{
border-style:solid;
border-width:1px;
border-color:var(--kw-sky-300)
}
.border-sky-200{
border-style:solid;
border-width:1px;
border-color:var(--kw-sky-200)
}
.border-sky-100{
border-style:solid;
border-width:1px;
border-color:var(--kw-sky-100)
}
.border-light{
border-style:solid;
border-width:1px;
border-color:var(--kw-light)
}
/**Colors end**/
/**Borders**/
/**Radius**/
...
/**Animations**/
.transition-all{transition:width 0.5s, height 0.5s , transform 0.5s, padding 0.5s, margin 0.5s}
/**Animation end**/
/**Cards**/
.card{
width:min(100% - 2vh);
